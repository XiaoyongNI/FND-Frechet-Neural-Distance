...
ckpt_path = '/net/inltitan1/scratch2/yuhxie/BrainBERT/BrainBERT/checkpoints/save_models_True_data/rate_0/EEGNet/T_1/pat_18_EEGNet_checkpoint_multipat.pt'
...
for N in Ns:
    ...
    for r in range(Repeat_time):
        ...
        print(X_sub.shape) # Shape: (N=50, 8000)
        ...
        F_avg = model(F_avg.unsqueeze(1).unsqueeze(1)) # Shape: (N=50,)
    ...
    np.save("Gaussian_check_results_"+cond+"_eegmulti1_N50_5k.npy", results)
