...
for N in Ns:
    ...
    np.save("FD_ValidationCheck/Gaussian_check_results_Hjorth_"+cond+"_N50_5k.npy", results_Hjorth)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_results_LL_"+cond+"_N50_5k.npy", results_LL)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_results_SK_"+cond+"_N50_5k.npy", results_SK)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_results_Kur_"+cond+"_N50_5k.npy", results_Kur)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_results_BP_"+cond+"_N50_5k.npy", results_BP)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_results_STFT_"+cond+"_N50_5k.npy", results_STFT)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_results_all_"+cond+"_N50_5k.npy", results_all)
