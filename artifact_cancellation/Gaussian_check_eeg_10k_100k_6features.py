...
for N in Ns:
    ...
    for r in range(Repeat_time):
        ...
        X_sub = resample(X_cond, n_samples=N, replace=True if N > 20000 else False)
        print(X_sub.shape)
        """Extract features."""
        # 1. Hjorth
    ...
    np.save("FD_ValidationCheck/Gaussian_check_eeg_results_Hjorth_"+cond+"_N10k_100k.npy", results_Hjorth)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_eeg_results_LL_"+cond+"_N10k_100k.npy", results_LL)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_eeg_results_Spike_"+cond+"_N10k_100k.npy", results_Spike)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_eeg_results_BP_"+cond+"_N10k_100k.npy", results_BP)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_eeg_results_STFT_"+cond+"_N10k_100k.npy", results_STFT)
    ...
    np.save("FD_ValidationCheck/Gaussian_check_eeg_results_all_"+cond+"_N10k_100k.npy", results_all)
