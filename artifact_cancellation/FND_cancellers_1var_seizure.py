...
path_clean = ["ASAR_seizure_amp73.npy","interpolation_seizure_amp73.npy","SVD_AcrossChannels_N1_seizure_amp73.npy"]
...
for i in range(len(path_clean)):
    ...
    for j in range(len(path_artifact)):
        ...
        if k == i*len(path_artifact)+j:
            print("seizure testing case: ", cases[k]) #i*len(path_artifact)+j
        else:
            print("error!")
